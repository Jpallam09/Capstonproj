...
<head>
  ...
  <title>User Login</title>
    <link rel="stylesheet" href="../auth/auth-css/login.css">
</head>
...
<body>
  <nav class="navbar" role="navigation" aria-label="Site main navigation">
    ...
    <div class="nav-right">
      <a href="register.php" aria-label="Go to registration page">Register</a>
    </div>
  </nav>
  ...
  <main>
    <section class="login-card" role="region" aria-labelledby="login-heading">
      ...
      <form novalidate>
        ...
        <input type="password" id="password" name="password" placeholder="Enter your password" autocomplete="current-password" required minlength="8" aria-describedby="password-desc" />
