...
<head>
  ...
  <title>User Registration</title>
    <link rel="stylesheet" href="../auth/auth-css/register.css">
</head>
<body>
  <nav class="navbar" role="navigation" aria-label="Site main navigation">
    ...
    <div class="nav-right">
      <a href="login.php" aria-label="Go to login page">Log In</a>
    </div>
  </nav>
  ...
  <main>
    <section class="registration-card" role="region" aria-labelledby="reg-heading">
      ...
      <form novalidate>
        ...
        <input type="text" id="username" name="username" placeholder="Choose a username" autocomplete="username" required minlength="3" maxlength="20" pattern="[\w\d_-]+" title="3-20 characters: letters, numbers, underscore or dash" aria-describedby="username-desc" />
        <small id="username-desc">Invalid username format!</small>

        <label for="email">Email Address</label>
        <input type="email" id="email" name="email" placeholder="you@example.com" autocomplete="email" required aria-describedby="email-desc" />
        ...
        <input type="password" id="password" name="password" placeholder="Create a password" autocomplete="new-password" required minlength="8" aria-describedby="password-desc" />
        <small id="password-desc">Password must be at least 8 characters.</small>

        <label for="confirm-password">Confirm Password</label>
        <input type="password" id="confirm-password" name="confirm-password" placeholder="Re-enter your password" autocomplete="new-password" required aria-describedby="confirm-password-desc" />
