...
<head>
  ...
  <title>Component Library - Build Your UI</title>
      <link rel="stylesheet" href="../auth/auth-css/index.css">
  </style>
</head>
<body>
  ...
  <header class="hero" role="banner" id="hero-section" aria-label="Hero section with background image and headline">
    ...
    <div class="hero-content container">
      ...
      <a href="register.php"><button class="cta-button" type="button" onclick="alert('Register Account?')">Get Started</button></a>
    </div>
  </header>
